...
ALIAS AND ARGLIST ARRAY BEGIN CASE CONST COPY DEFINITION DIV DO ELSE ELSIF
END EXIT FOR IF IMPLEMENTATION IMPORT IN LOOP MOD MODULE NEW NOT OF OPAQUE
OR POINTER PROCEDURE READ RECORD RELEASE REPEAT RETURN SET THEN TO TYPE
